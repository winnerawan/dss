                    ...
                    <div class="card-box">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12 col-md-10">
                                ...
                                <div class="p-20">
                                    {!! Form::open(['route' => 'admin.kriteria.store', 'data-parsley-validate' => '', 'files' => true, 'method' => 'POST  ']) !!}
                                    ...
                                    <div class="form-group text-right m-b-0">
                                        ...
                                        <button type="reset" class="btn btn-secondary btn-danger waves-effect m-l-5"
                                                onclick="clearFormKriteria()">
                                            Clear
                                        </button>
